    ...
    <>
      <header className="absolute inset-x-0 top-0 z-50 text-white">
        ...
        <nav
          ...
          className="relative z-[100] border-b border-white/10 bg-black/20 backdrop-blur-md"
        >
          <div className="mx-auto flex h-[72px] max-w-[1400px] items-center justify-between px-4 lg:px-6">
            ...
            <div className="hidden items-center gap-1 lg:flex">
              ...
              <Button
                ...
                title="Shopping cart"
                className="h-8 rounded-full border border-white/20 bg-[#392A22] px-4 text-xs text-white hover:bg-[#4A382E]"
              >
