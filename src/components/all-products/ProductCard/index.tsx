...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div
      ...
      className="group flex h-full flex-col overflow-hidden rounded-[24px] border border-[#E9DDD4] bg-[#fdf9f6] transition-all duration-300 cursor-pointer"
    >
      ...
      <div className="flex flex-1 flex-col px-5 pb-5 pt-5">
        ...
        <div className="mt-auto">
          ...
          <button
            ...
            className={`flex w-full items-center justify-center gap-2 rounded-full py-3 text-sm font-medium cursor-pointer transition ${
              isOutOfStock
